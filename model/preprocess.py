...
from transformers import AutoModel,InputExample
...
class AlbertNerModel(BaseModel):  # 使用 ALBERT 模型类
    def __init__(self, args):
        ...
        # 载入 ALBERT 模型
        self.albert = AutoModel.from_pretrained(args.ERT) #模型
        self.classifier = torch.nn.Linear(self.albert.conbert_dir)  # 使用 ALBfig.hidden_size, args.num_tags)
